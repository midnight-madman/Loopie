...
export default function FeedbackModalComponent({open, setOpen}) {
    ...
    useEffect(() => {
        ...
        Reform('init', {
            url: 'https://forms.reform.app/j1YnyM/make-loopie-better/rvpjpw',
            ...
            &#8203;
                    ...
                    >
                        <div
                            ...
                            <div className="-mt-12" id="feedback-reform"/>
