...
export const ConnectButton = ({ buttonClassName }: { buttonClassName?: string }) => {
  ...
  const renderButton = ({
    ...
    <button
      ...
      className={clsx(buttonClassName, 'inline-flex items-center rounded-md border border-transparent px-4 py-2 lg:px-8 lg:py-3 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-200 focus:ring-offset-2')}
    >
      {text}
      {children}
    </button>
