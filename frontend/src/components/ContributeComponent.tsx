...
const tabs = [
  { name: 'Web3 News: Yes/No', href: '#', current: true, enabled: true },
  { name: 'More tasks', href: '#', current: false, enabled: false },
  { name: 'coming soon', href: '#', current: false, enabled: false }
]
...
export function ContributeComponent () {
  ...
  const renderConnectComponent = () => {
    return <div className="h-screen grid grid-cols place-content-center">
            {openConnectModal && <ConnectButton />}
        </div>
  }
