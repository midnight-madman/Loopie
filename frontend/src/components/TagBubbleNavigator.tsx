  ...
  return (
    <li>
      ...
      >
        ...
        {isActive && (
          <span
            className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-pink-500/0  via-pink-500/40 to-pink-500/0"/>
        )}
      </Link>
    </li>
  )
...
export const TagBubbleNavigator = () => {
  ...
  return <nav>
    <ul
      className="flex rounded-full bg-white/90 px-1 sm:px-3 text-sm font-medium text-slate-800 shadow-lg shadow-slate-800/5 ring-1 ring-slate-900/5 backdrop-blur">
